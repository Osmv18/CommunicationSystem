    ...
    <nav class="nav">
        <a class="logo" href="publicaciones.php"><img src="Images/LogoIngenieria.png" alt="Logo Escuela Ingenieria en Sistemas"></a>
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-menu-item">
                <a href="/admin_cuenta.php" class="nav-menu-link nav-link">Cuenta</a>
            </li>
        </ul>
    </nav>
